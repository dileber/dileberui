package com.drcosu.ndileber.dileberui.dialog.select;
...
import com.drcosu.ndileber.dileberui.dialog.select.model.SelectModel;
...
public class SelectDialog<T extends SelectModel> extends BaseNoticeWindow implements OnClickListener {
    ...
    private void init(){
        ...
        titleTextView.setBackgroundColor(getColor(R.color.select_topbar));
        ...
        layout.setBackgroundColor(getColor(R.color.select_white));
        ...
        mainLayout.setBackgroundColor(getColor(R.color.select_alpha50));
        ...
        for (int i = 0; i < size + 1; i++) {
            ...
            if (i == size) {
                ...
                tDiscardBtn.setBackgroundColor(getColor(R.color.select_white));
                tDiscardBtn.setTextColor(getColor(R.color.select_topbar));
            } else {
            ...
            textView.setBackgroundColor(getColor(R.color.select_line));
...
//        this.setAnimationStyle(R.style.menu_dialog_animation);
    ...
    public void setAllButtonStyle() {
        for (Button button : buttonList) {
            ...
            button.setBackgroundColor(getColor(R.color.select_white));
            button.setTextColor(getColor(R.color.select_text_10));
        }
    }
